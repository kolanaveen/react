    ...
    <>
        <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
            <div className="flex h-16 justify-between">
                <div className="flex px-2 lg:px-0">
                    <div className="cursor-pointer flex flex-shrink-0 items-center" onClick={()=> navigate('/')}>
                    ...
                    <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
                        <p onClick={()=> navigate('/')}
                            ...
                            ${pathMatchRoute('/') && "border-indigo-500 text-gray-900 border-b-2"}`}>
                            Home
                        </p>
                        <p onClick={()=> navigate('/profile')}
                            className={`cursor-pointer inline-flex items-center px-1 pt-1 text-sm font-medium
                            ${pathMatchRoute('/profile') && "border-indigo-500 text-gray-900 border-b-2"}`}>
                            Profile
                        </p>
        ...
        <Disclosure.Panel className="lg:hidden">
            <div className="space-y-1 pb-3 pt-2">
                {/* Current: "bg-indigo-50 border-indigo-500 text-indigo-700", Default: "border-transparent
